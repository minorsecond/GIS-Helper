...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.copyTiffOutputWindow.setGeometry(QtCore.QRect(10, 190, 761, 341))
        ...
        MainWindow.setTabOrder(self.northYEntry, self.westXEntry)
        MainWindow.setTabOrder(self.westXEntry, self.eastXEntry)
        MainWindow.setTabOrder(self.eastXEntry, self.southYEntry)
        MainWindow.setTabOrder(self.southYEntry, self.ddButtonCalcOrigin_2)
        MainWindow.setTabOrder(self.ddButtonCalcOrigin_2, self.llButtonCalcOrigin_4)
        MainWindow.setTabOrder(self.llButtonCalcOrigin_4, self.originOutputBox)
        MainWindow.setTabOrder(self.originOutputBox, self.dmsToDD)
        MainWindow.setTabOrder(self.dmsToDD, self.DDToDMS)
        MainWindow.setTabOrder(self.DDToDMS, self.converCoordsEntry)
        MainWindow.setTabOrder(self.converCoordsEntry, self.converterOutput)
        MainWindow.setTabOrder(self.converterOutput, self.originClearButton)
        MainWindow.setTabOrder(self.originClearButton, self.originCalculateButton)
        MainWindow.setTabOrder(self.originCalculateButton, self.convCoordClear)
        MainWindow.setTabOrder(self.convCoordClear, self.convCoordCalc)
        MainWindow.setTabOrder(self.convCoordCalc, self.tabContainer)
        MainWindow.setTabOrder(self.tabContainer, self.catalogTiffBrowseButton)
        MainWindow.setTabOrder(self.catalogTiffBrowseButton, self.catalogTiffBOutputrowseButton)
        MainWindow.setTabOrder(self.catalogTiffBOutputrowseButton, self.FanOutByRes)
        MainWindow.setTabOrder(self.FanOutByRes, self.geoTiffDir1)
        MainWindow.setTabOrder(self.geoTiffDir1, self.TiffCatalogOutputEdit)
        MainWindow.setTabOrder(self.TiffCatalogOutputEdit, self.catalogTiffProcess)
        MainWindow.setTabOrder(self.catalogTiffProcess, self.catalogTiffOutputWindow)
        MainWindow.setTabOrder(self.catalogTiffOutputWindow, self.TiffDirectory)
        MainWindow.setTabOrder(self.TiffDirectory, self.intersectingShapefileEdit)
        MainWindow.setTabOrder(self.intersectingShapefileEdit, self.geoTiffOutputDirEdit)
        MainWindow.setTabOrder(self.geoTiffOutputDirEdit, self.BrowseForTifDir)
        MainWindow.setTabOrder(self.BrowseForTifDir, self.BrowseForIntShape)
        MainWindow.setTabOrder(self.BrowseForIntShape, self.BrowseForGeoTiffOutputDir)
        MainWindow.setTabOrder(self.BrowseForGeoTiffOutputDir, self.CopyFanoutByResolution)
        MainWindow.setTabOrder(self.CopyFanoutByResolution, self.CopyTiffProcess)
        MainWindow.setTabOrder(self.CopyTiffProcess, self.copyTiffOutputWindow)
        MainWindow.setTabOrder(self.copyTiffOutputWindow, self.shapeViewWindow)
        MainWindow.setTabOrder(self.shapeViewWindow, self.shapefileViewPath)
        MainWindow.setTabOrder(self.shapefileViewPath, self.shapefileViewBrowseButton)
        MainWindow.setTabOrder(self.shapefileViewBrowseButton, self.shapefileViewClear)
        MainWindow.setTabOrder(self.shapefileViewClear, self.shapefileViewGo)
