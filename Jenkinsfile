pipeline {
    ...
    stages {
	    ...
	    stage('Deliver') {
            ...
            steps {
                sh '/c/Users/Ross/miniconda3/condabin/conda.bat env remove -y --name GIS-Helper'
                ...
                sh '/c/Users/Ross/miniconda3/condabin/conda.bat install -y -c conda-forge mkl-service'
                sh '/c/Users/Ross/miniconda3/Scripts/pyinstaller --onefile gh-debug.spec'
            }
            post {
                success {
                    sh 'ls'
